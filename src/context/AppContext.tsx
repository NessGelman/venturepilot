...
import type { AppState, AppAction, DerivedMetrics, UseAppReturn, Preset, DailySnapshot } from '../types/AppContext.types';
...
export const AppProvider = ({ children }: AppProviderProps) => {
  ...
  // Setter helpers
  const createSetter = useCallback(<K extends keyof Omit<AppState, 'history' | 'future' | 'presets' | 'dailySnapshots' | 'lastSaved'>>(field: K) => 
    useCallback((value: AppState[K]) => {
