...
Onward,
${E||`[Your Name]`}
${a}`:k===`professional`?`Subject: ${n}

${t}

I hope this message finds you well. Please find below our ${j} business update for ${a} for the period ending ${G}.
